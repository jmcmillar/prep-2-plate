class Import::Parsers::BaseParser
  ...
  def canonical_url_matches_domain?(domain)
    Import::CanonicalUrlParser.new(nokogiri_doc).canonical_domain == domain
  end

  def canonical_url_includes?(phrase)
    !Import::CanonicalUrlParser.new(nokogiri_doc).canonical_url.nil? && Import::CanonicalUrlParser.new(nokogiri_doc).canonical_url.include?(phrase)
  end
  ...
  def parse_canonical_url
    Import::CanonicalUrlParser.new(nokogiri_doc).canonical_url
  end
